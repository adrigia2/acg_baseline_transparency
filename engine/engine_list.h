...
//////////
   ...
   // Rendering:   
   bool render(const Eng::Camera &camera, Pass pass = Pass::all) const;
   bool render(const glm::mat4 &cameraMatrix, const glm::mat4 &projectionMatrix, Pass pass = Pass::all) const;
